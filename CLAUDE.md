...
| `0b_helper.gs` | Reusable utility functions, liturgical helpers | `HELPER_*()`, `PRECEDENCE`, `LITURGICAL_COLORS` |
...
Colors defined in `LITURGICAL_COLORS` constant in 0b_helper.gs:
...
**Codebase Version**: Based on commit 4bb0e08 (Recent schedule logic updates)
